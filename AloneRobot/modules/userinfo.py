...
import AloneRobot.modules.sql.userinfo_sql as sql
...
from AloneRobot import telethn as AloneTelethonClient
from AloneRobot.__main__ import STATS, TOKEN, USER_INFO
...
from AloneRobot.modules.sql.afk_sql import check_afk_status, is_afk
from AloneRobot.modules.sql.global_bans_sql import is_user_gbanned
from AloneRobot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/Alonebotzone/26">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
