            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ᴅᴇᴠᴇʟᴏᴘᴇʀ", url=f"https://t.me/ALONE_WAS_BOT"
                            ),
                            InlineKeyboardButton(
                                "Dɪsᴀsᴛᴇʀ", url="https://t.me/ALONE_WAS_BOT"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/ALONE_WAS_BOT"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
...
def set_about_me(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if repl_user_id in [bot.id, 777000, 6079943111] and (user_id in DEV_USERS):
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id in [6079943111] and sender_id not in DEV_USERS:
